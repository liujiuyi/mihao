...
class OrderModel extends BaseModel {
    ...
    function user_bonus($user_id, $goods_amount = 0) {
        ...
        $sql = "SELECT t.type_id, t.type_name, t.type_money, t.act_range, t.act_range_ext, b.bonus_id " .
    ...
    /**
     * 验证商品是否符合使用红包规则
     * @param   array     $bonus        红包数组
     * @return  int   红包数量
     */
    function check_bonus_used($bonus) {
        $sql = "SELECT count(c.goods_id) AS goods_count " .
