...
$_LANG['shipping_name'] = '配送站名称';
$_LANG['shipping_version'] = '插件版本';
$_LANG['shipping_desc'] = '配送站描述';
...
$_LANG['no_shipping_install'] = '您的配送站尚未安装，暂不能编辑模板';
$_LANG['edit_template_success'] = '快递模板已经成功编辑。';

/* JS 语言 */
$_LANG['js_languages']['lang_removeconfirm'] = '您确定要卸载该配送站吗？';
